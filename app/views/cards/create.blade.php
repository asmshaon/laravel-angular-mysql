...
{{ Form::open(['route'=>'cards.store', 'method'=>'post', 'class'=>'form-horizontal', 'id'=>'card-form']) }}
    <fieldset>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
          {{ Form::text('post_code', '', array('class'=>'form-control', 'id'=>'post_code', 'placeholder' => 'Post Code')) }}
      ...
      <div class="form-group">
        <div class="col-sm-offset-3 col-sm-9">
          {{ Form::button('Add Now', array( 'type' => 'submit', 'class'=>"btn btn-default")) }}
        </div>
      </div>
    </fieldset>
{{ Form::close() }}
